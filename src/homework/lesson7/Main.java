...
public class Main {
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Александр",7, "математика");
        Student student2 = new Student("Алексей",8, "математика");
        Student student3 = new Student("Александр",9, "математика");
